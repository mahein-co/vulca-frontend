...
function App() {
    ...
    useEffect(() => {
        if (isAuthenticated) {
            ...
            // [NEW] If project IS selected and user tries to go to selection page, block it (redirect to dashboard)
            // This prevents "going back" to selection once a dossier is open
            if (selectedProjectId && isSelectProjectPage) {
