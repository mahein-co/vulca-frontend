 ...
 */
const LoadingOverlay = ({ message = "Traitement en cours...", fullScreen = true }) => {
    ...
    return (
        <div className={`${containerClasses} flex flex-col items-center justify-center p-4 transition-all duration-300 animate-in fade-in`}>
