...
export default function LargeSidebar() {
  return (
    <React.Fragment>
      <aside className="hidden lg:block w-48 bg-white shadow-md">
        <div className="flex flex-col items-center max-h-screen h-full overflow-hidden text-gray-700 rounded">
